    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 pt-24 relative z-10">
                {/* Layout: text left, avatar right on md+; stacked on small screens */}
                <div className="max-w-5xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12">
                    ...
                    <div className="w-full md:w-2/3 text-center md:text-left">
                        ...
                        <motion.p
                            ...
                            className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto md:mx-0 mb-12 leading-relaxed"
                        >
